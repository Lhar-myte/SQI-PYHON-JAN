...
# Write a Python function called area_of_circle(radius, pi) that calculates and returns the area of a circle. 
# If PI is not provided, it should default to 22/7.

# The formula is (pi * (radius square))
...
# # 4. Using the is_prime(n) function from number 3, write a function that asks a user for an input n 
# # and returns all the prime numbers up to n.
...
# 5. Write a function lesser_of_two_evens(a, b) that returns the lesser of two given 
...
# and returns True if both words begin with the same letter.
...
# print(spy_game([1, 0, 2, 4, 0, 5, 7, 0]))
# print(spy_game([1, 7, 2, 0, 4, 5, 0]))
# print(spy_game([9, 8, 0, 8, 9, 7, 0, 1, 2, 3, 0, 3, 1, 0, 1, 2, 8, 7]))
...
#     return all(alphabet in text for alphabet in alphabets)
...
#     # return alphabets.issubset(text.lower())
#     return alphabets <= set(text.lower())
...
# print(are_anagrams("angle", "angel"))
...
# print(calculate_simple_interest(800, 5, 3))
